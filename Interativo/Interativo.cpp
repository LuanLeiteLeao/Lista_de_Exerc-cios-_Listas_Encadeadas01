...
/*Esta funcao fara o trabalho de copiar uma lista encadeada pronta
numa segunda lista encadeada, a qual sera criada dentro da funcao que devera ser devolvida
pelo return a lista pronta para o int main*/

lista *CopiaEncadeada(lista *MinhaCelula1)
{
	/*Uma auxiliar lista eh criada comecando com NULL para iniciar ela
	recebendo as mesmas variaveis da MinhaCelula1*/
	
	lista *CelulaCopia = NULL;
	for (lista *ProximoAux = MinhaCelula1; ProximoAux != NULL; ProximoAux = ProximoAux->prox)
	{
		/*O CelulaCopia recebera o valor da "variavel" MinhaCelula1 no final dela,
		Assim fazendo o trabalho de preencher com os mesmos numeros*/
...
/*A funcao ira concatenar as listas, ou seja, colocar uma delas ao final de uma lista
Interligando ambas*/
...
lista *ConcatenaLista(lista *MinhaCelula1, lista *MinhaCelula2)
{
	...
	/*Este for apenas ira levar ate o final da lista, onde se encontra o NULL para entao fazer
	  o que a funcao foi feita para fazer*/
	   
	for (ProximoAux = MinhaCelula1; ProximoAux->prox != NULL; ProximoAux = ProximoAux->prox)
	{
	}
	
	//Isto faz com que o final de uma lista se ligue a outra
	ProximoAux->prox = MinhaCelula2;
	
	//Este retorno eh importante para devolver o novo valor da lista
	return MinhaCelula1;
}

//7.Escreva uma funcao que conte o numero de celulas de uma lista encadeada.

/*Esta funcao ira contar quantas celulas (casas) estao preenchidas*/

int ContarCelulas(lista *MinhaCelula)
{
	int Cont = 1;
	
	/*Percorrera toda a lista ate encontrar NULL, enquanto nao encontrar,
	  ele ira contar +1 na variavel*/
	...
	//Retorna o valor que foi registrado enquanto o for funcionava
	return Cont;
}
...
/*Esta funcao ira comparar as listas se*/
int ComparaListaItera(lista *MinhaCelula1, lista *MinhaCelula2)
{
	...
	{
		//Este if ira comparar se o numero da posicao 1 eh o mesmo da outra lista com a mesma posicao
		//Se for igual, nao ira entrar e ira parar o seu funcionamento
...
int ComparaListaRecur(lista *MinhaCelula1, lista *MinhaCelula2)
{
